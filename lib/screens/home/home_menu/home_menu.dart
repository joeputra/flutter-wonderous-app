...
import 'package:playground_1/screens/home/home_menu/about_dialog_content.dart';
import 'package:playground_1/ui/common/app_backdrop.dart';
import 'package:playground_1/ui/common/controls/app_header.dart';
import 'package:playground_1/ui/common/controls/locale_switcher.dart';
import 'package:playground_1/ui/common/pop_navigator_underlay.dart';
import 'package:playground_1/ui/common/wonderous_logo.dart';
  ...
  void _handleAboutPressed(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      applicationIcon: Container(
        ...
        child: const WonderousLogo(width: 52),
      ),
    );
  }
              ...
              child: ExpandedScrollingColumn(
                ...
                children: [
                  ...
                  _buildIconGrid(context)
                      ...
                      .scale(
                          begin: const Offset(.8, .8), curve: Curves.easeOut),
